...
const MOCK_DATA: InsightData = {
  ...
  qualitative: {
    impressiveWorkflows: {
      intro:
        "You're a highly active Hanhai CLI user with 314 sessions over 67 days, achieving strong results in test creation, PR workflows, and debugging with a 68% success rate on clear tasks.",
    ...
    memorableMoment: {
      ...
      detail:
        "During what appears to be routine development work, a user stopped everything to ask Hanhai to confirm its corporate origins. Qwen correctly identified itself as Alibaba's model, not Zhipu's GLM. A rare moment of AI identity verification in the wild.",
    },
    improvements: {
      Qwen_md_additions: [
        {
          ...
          prompt_scaffold:
            'Create new ## Code Review Standards section in HANHAI.md',
        },
        {
          addition:
          ...
          prompt_scaffold:
            'Create new ## Testing Conventions section in HANHAI.md',
        },
        {
          addition:
          ...
          prompt_scaffold: 'Create new ## PR Workflow section in HANHAI.md',
        },
      ],
      features_to_try: [
        {
      ...
      usage_patterns: [
        ...
        },
        {
          ...
          copyable_prompt:
            'Create .hanhai/skills/pr/SKILL.md with your PR template requirements, then just type /pr',
        },
        {
