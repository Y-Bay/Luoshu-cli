...
const MOCK_DATA: InsightData = {
  ...
  qualitative: {
    impressiveWorkflows: {
      intro:
        "You're a highly active Luoshu CLI user with 314 sessions over 67 days, achieving strong results in test creation, PR workflows, and debugging with a 68% success rate on clear tasks.",
    ...
    improvements: {
      Qwen_md_additions: [
        {
          ...
          prompt_scaffold:
            'Create new ## Code Review Standards section in LUOSHU.md',
        },
        {
          addition:
          ...
          prompt_scaffold:
            'Create new ## Testing Conventions section in LUOSHU.md',
        },
        {
          addition:
          ...
          prompt_scaffold: 'Create new ## PR Workflow section in LUOSHU.md',
        },
      ],
      features_to_try: [
        {
      ...
      usage_patterns: [
        ...
        },
        {
          ...
          copyable_prompt:
            'Create .luoshu/skills/pr/SKILL.md with your PR template requirements, then just type /pr',
        },
        {
