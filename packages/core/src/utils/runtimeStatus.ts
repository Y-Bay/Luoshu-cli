 ...
 *
 * Runtime status sidecar for an active interactive Hanhai CLI session.
 *
 ...
 *
 *     "Which Hanhai CLI session is the running PID X serving?"
 *
...
/** Snapshot of a live Hanhai CLI session process for external observers. */
 ...
 * dataclass.
 *
 * Note: a returned record only proves that *some* Hanhai CLI process
