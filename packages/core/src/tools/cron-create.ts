    ...
    try {
      ...
      if (recurring) {
        llmContent =
          ...
          'Session-only (not written to disk, dies when Hanhai CLI exits). ' +
  ...
  constructor(private config: Config) {
    super(
      ...
      'Schedule a prompt to be enqueued at a future time. Use for both recurring schedules and one-shot reminders.\n\n' +
        ...
        '## Session-only\n\n' +
        'Jobs live only in this Hanhai CLI session — nothing is written to disk, and the job is gone when Hanhai CLI exits.\n\n' +
        '## Runtime behavior\n\n' +
