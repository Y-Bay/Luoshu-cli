 ...
 * This file handles the creation and maintenance of ~/.hanhai/output-language.md
...
/**
 * Returns the path to the LLM output language rule file (~/.hanhai/output-language.md).
 */
