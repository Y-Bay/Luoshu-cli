 ...
 * This file handles the creation and maintenance of ~/.luoshu/output-language.md
...
/**
 * Returns the path to the LLM output language rule file (~/.luoshu/output-language.md).
 */
