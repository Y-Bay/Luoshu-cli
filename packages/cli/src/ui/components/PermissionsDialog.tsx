  ...
  return [
    {
      ...
      description: t('Checked in at .hanhai/settings.json'),
      value: SettingScope.Workspace,
      key: 'project',
    },
    {
      label: t('User settings'),
      description: t('Saved in at ~/.hanhai/settings.json'),
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("Hanhai CLI won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('Hanhai CLI will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('Hanhai CLI is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
