 ...
 * Handles bidirectional sync between VSCode Settings and ~/.hanhai/settings.json.
 */
...
/**
 * Mode for ~/.hanhai/settings.json — owner-only read/write. The unified install
...
/**
 * Values extracted from ~/.hanhai/settings.json for populating VSCode Settings.
 */
 ...
 * so that `JSON.parse` can handle ~/.hanhai/settings.json files that
...
/**
 * Read ~/.hanhai/settings.json. Returns {} if the file is missing.
...
function readSettings(): Record<string, unknown> {
  ...
  try {
    ...
    throw new Error(
      `Cannot parse ~/.hanhai/settings.json (${message}). ` +
...
/**
 * Write ~/.hanhai/settings.json atomically (temp file + rename), creating the
...
// ---------------------------------------------------------------------------
// Write: VSCode Settings → ~/.hanhai/settings.json
// ---------------------------------------------------------------------------

/**
 * Write Coding Plan configuration to ~/.hanhai/settings.json.
...
/**
 * Write model providers from VSCode Settings (key-value map) to ~/.hanhai/settings.json.
...
/**
 * Create a ProviderSettingsAdapter backed by ~/.hanhai/settings.json.
...
/**
 * Apply a ProviderInstallPlan to ~/.hanhai/settings.json.
...
// ---------------------------------------------------------------------------
// Read: ~/.hanhai/settings.json → VSCode Settings
// ---------------------------------------------------------------------------

/**
 * Read ~/.hanhai/settings.json and extract values for VSCode Settings UI.
...
/**
 * Clear persisted auth credentials from ~/.hanhai/settings.json.
