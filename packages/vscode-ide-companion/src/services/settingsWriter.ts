 ...
 * Handles bidirectional sync between VSCode Settings and ~/.luoshu/settings.json.
 */
...
/**
 * Mode for ~/.luoshu/settings.json — owner-only read/write. The unified install
...
/**
 * Values extracted from ~/.luoshu/settings.json for populating VSCode Settings.
 */
 ...
 * so that `JSON.parse` can handle ~/.luoshu/settings.json files that
...
/**
 * Read ~/.luoshu/settings.json. Returns {} if the file is missing.
...
function readSettings(): Record<string, unknown> {
  ...
  try {
    ...
    throw new Error(
      `Cannot parse ~/.luoshu/settings.json (${message}). ` +
...
/**
 * Write ~/.luoshu/settings.json atomically (temp file + rename), creating the
...
// ---------------------------------------------------------------------------
// Write: VSCode Settings → ~/.luoshu/settings.json
// ---------------------------------------------------------------------------

/**
 * Write Coding Plan configuration to ~/.luoshu/settings.json.
...
/**
 * Write model providers from VSCode Settings (key-value map) to ~/.luoshu/settings.json.
...
/**
 * Create a ProviderSettingsAdapter backed by ~/.luoshu/settings.json.
...
/**
 * Apply a ProviderInstallPlan to ~/.luoshu/settings.json.
...
// ---------------------------------------------------------------------------
// Read: ~/.luoshu/settings.json → VSCode Settings
// ---------------------------------------------------------------------------

/**
 * Read ~/.luoshu/settings.json and extract values for VSCode Settings UI.
...
/**
 * Clear persisted auth credentials from ~/.luoshu/settings.json.
